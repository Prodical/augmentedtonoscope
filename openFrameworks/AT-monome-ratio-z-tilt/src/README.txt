...
- sends mfrequency value to Ronin Synth via OSC - requires a small hack of the ofxOSC addon since Arduino doesn't accept #bundles
...
commented out of ofxOscSender.cpp
//--------------------------
void ofxOscSender::sendMessage( ofxOscMessage& message )
{
    ...
    // Z_OSC doesn't accept bundles so cooment out the lines below according to:
